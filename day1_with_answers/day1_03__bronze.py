...
df.createOrReplaceTempView("tmp_customers")
...
# MAGIC 
# MAGIC CREATE OR REPLACE TABLE customers_bronze 
# MAGIC TBLPROPERTIES (
...
# MAGIC %md
# MAGIC ### Q3.半構造化データをbronzeテーブルとして読み込む
...
# MAGIC %sql
# MAGIC -- ToDo `olist_sellers_dataset_bronze`をテーブル名として、すべてのカラムを文字列で保持したBronzeテーブルを作成してください。
...
# MAGIC %md
# MAGIC ### Q4. deltaのタイムトラベル機能による誤ったデータの取り込みを修正
