...
# MAGIC - 昨日作成したdelta table(sales_history_gold)から、Dataframe : orderitem_joinDFとしてreadを行なってください
# MAGIC 
...
# MAGIC %md ## Q3. Cast & Renamed 
# MAGIC - orderitemDF_add2018/2019/2020/2021/allのds schemaをdate形式にcastしてください。
# MAGIC - orderitem_joinDFのpurchase_dateをdateへ、salesをyへ変更してください
...
orderitem_joinDF = orderitem_joinDF.withColumnRenamed('purchase_date', 'ds').withColumnRenamed('sales', 'y')
