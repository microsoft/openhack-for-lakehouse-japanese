...
# MAGIC │   ├── day3/{user_name}
# MAGIC │   │   ├── database    <- Day3で利用するデータベースのディレクトリ
# MAGIC ```
# MAGIC 
...
database = f"{dbutils.widgets.get('database_name')}_day3_{user_name}"


# Day1で利用する作業領域のディレクトリ
data_path       = f'/FileStore/db_openhackason_2022/day3/{user_name}'
